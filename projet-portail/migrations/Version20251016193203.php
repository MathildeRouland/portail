 ...
 */
final class Version20251016193203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE opening_history ADD customer_name VARCHAR(255) DEFAULT NULL, ADD link_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE opening_history DROP customer_name, DROP link_id');
    }
}
