...
class SettingsController extends AbstractController
{
    ...
    public function content(Request $request, EntityManagerInterface $em): Response
    {
    ...
    public function appearance(Request $request, EntityManagerInterface $em): Response
    {
        $settings = $em->getRepository(Settings::class)->findOneBy([]) ?? new Settings();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // Supprimer l'ancienne image si demandé ou si une nouvelle est uploadée
            if (($form->get('removeBackground')->getData() || $form->get('backgroundImage')->getData()) && $settings->getBackgroundImage()) {
